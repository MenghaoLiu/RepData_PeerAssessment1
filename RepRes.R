...
## Make a histogram of the total number of steps taken each day with new data 
...
## Calculate the mean and median of the total number of steps taken per day of 
## the new data
...
## Create a new factor variable weekcat in impDT with two levels -¨C ¡°weekday¡± 
...
## Use aggregate() FUN to collapse impDT and aggDT4 dataset showing the average 
## number of steps taken by 5-minute interval and weekcat
